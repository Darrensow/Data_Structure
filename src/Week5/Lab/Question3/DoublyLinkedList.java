...
public class DoublyLinkedList<E> {
    ...
    public void addFirst(E element) {
        ...
        //points tmp to the head of the original doublyLinkedList
    ...
    public void addLast(E element) {
        ...
        //points the tmp to the previous node(tail)
    ...
    public void add(int index, E element){
        ...
        if(index == 0)
            ...
            // set from head and begin traverse stop on required position
            Node<E> temp = head;
    ...
    public void clear(){
        ...
        size = 0;
        System.out.println("Successfully cleared " + count + " node(s)");
    }
}
